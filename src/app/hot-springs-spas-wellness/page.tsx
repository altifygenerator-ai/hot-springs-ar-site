...
export const metadata: Metadata = {
  ...
  description:
    "Explore spas, wellness stops, bathhouses, aesthetic care, facials, skin health, body sculpting, thermal baths, and relaxing experiences in Hot Springs, Arkansas.",
  keywords: [
...
const guideCards = [
  {
    title: "For classic Hot Springs history",
    text: "Start with Bathhouse Row, Buckstaff, or Quapaw if you want the thermal water and historic bathhouse side of Hot Springs.",
    href: "/bathhouse-row",
    cta: "Explore Bathhouse Row",
  },
  {
    title: "For modern skin and aesthetic care",
    text: "Spa City Aesthetics is the better fit for facial analysis, regenerative skin care, body sculpting, and personalized non-invasive treatments.",
    href: "/spa-city-aesthetics-hot-springs",
    cta: "Read Spa City Spotlight",
  },
  {
    title: "For a resort spa day",
    text: "Oaklawn and The Arlington both fit visitors looking for a hotel, resort, salon, or spa experience tied to a larger property.",
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "A bathhouse is usually tied to thermal bathing, soaking, massage, or historic spa experiences. A modern aesthetics studio is more focused on services like facial analysis, skin health, body sculpting, regenerative treatments, and non-invasive aesthetic care.",
  },
  {
  ...
  return (
    <main>
          ...
          __html: JSON.stringify([
            {
              ...
              description:
                "A local guide to spas, bathhouses, wellness businesses, aesthetic care, facials, body sculpting, thermal baths, and relaxation in Hot Springs, Arkansas.",
      ...
      <section className="relative flex min-h-[720px] items-end overflow-hidden bg-[#17251f] pb-16 pt-32">
        <Image
          src={hero.image}
          alt="Spas and wellness in Hot Springs Arkansas"
          fill
          priority
          sizes="100vw"
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl text-white">
            ...
            <h1 className="text-white">
              Relax, reset, and find modern wellness in Hot Springs.
            </h1>
      ...
      <section id="spa-guide" className="section bg-white/35">
        <div className="container">
          <div className="section-heading">
            ...
            <p>
              A few other well-known places to consider for thermal baths,
              resort spa services, massage, salon services, and classic Hot
              Springs relaxation.
            </p>
          </div>
